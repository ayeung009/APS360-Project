...
| ```final_merged_dataset``` | Contains the finalized dataset used for the training, testing, and validation of the models (both baseline and primary). It is the combination of the cleaned and repurposed Roboflow data and the self generated data. All data in this dataset is cleaned with no duplicates or errors. All data is stored in ```final_labels.csv``` |
